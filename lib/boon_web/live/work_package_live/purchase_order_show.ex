  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <section class="space-y-6">
          ...
          <BoonWeb.Components.Card.card_content space="large">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div class="space-y-3">
                ...
                <div class="space-y-2">
                  <p class="text-sm text-stone-400">WP {@work_package.number}</p>

                  <h1 class="text-4xl font-semibold text-stone-50">PO {@purchase_order.po_number}</h1>
                </div>
              </div>
        ...
        <BoonWeb.Components.Card.card
          id={"purchase-order-detail-#{@purchase_order.id}"}
          variant="bordered"
          color="warning"
          rounded="extra_large"
          class="app-panel"
        ...
        >
          <BoonWeb.Components.Card.card_content space="large">
            <div class="grid gap-4 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div>
                <div>
                  <p class="app-kicker text-[0.68rem]">Purchase Order Detail</p>
